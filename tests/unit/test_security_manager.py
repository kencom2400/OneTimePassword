...
class TestSecurityManager:
    ...
    def test_list_accounts_normal(self, security_manager):
        ...
        # 複数のアカウントを追加
        security_manager.add_account("Device1", "user1@example.com", "Service1", "SECRET1")
        security_manager.add_account("Device2", "user2@example.com", "Service2", "SECRET2")
    ...
    def test_update_account_invalid_id(self, security_manager):
        ...
        success = security_manager.update_account("", account_name="updated@example.com")
        assert success is False
    ...
    def test_search_accounts_by_issuer(self, security_manager):
        ...
        security_manager.add_account("Device1", "user1@example.com", "GitHub", "SECRET1")
        security_manager.add_account("Device2", "user2@example.com", "Google", "SECRET2")
    ...
    def test_get_account_count_after_delete(self, security_manager):
        ...
        account_id = security_manager.add_account("Device1", "user1@example.com", "Service1", "SECRET1")
        assert security_manager.get_account_count() == 1
    ...
    def test_file_access_permission_error(self, security_manager):
        ...
        with patch('builtins.open', side_effect=PermissionError("Permission denied")):
            with pytest.raises(Exception):
                security_manager.add_account("Device", "user@example.com", "Service", "SECRET")
